...
- Test levels are generic (unit / integration / e2e / contract / load) — **no test-runner, broker, or load-tool name is hard-coded** (the load tool is named only as "the one in your repo, or e.g. k6 / Locust").
